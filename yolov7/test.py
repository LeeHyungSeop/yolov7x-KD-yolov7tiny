...
# test using customzied dataset 
https://colab.research.google.com/github/roboflow-ai/notebooks/blob/main/notebooks/train-yolov7-object-detection-on-custom-data.ipynb#scrollTo=N4cfnLtTCIce

asset : https://github.com/WongKinYiu/yolov7/releases/tag/v0.1


python test.py --img 640 --batch 4 \
    --data data/dataset_person_coco_10000.yaml \
    --conf 0.001 --iou 0.65 \
